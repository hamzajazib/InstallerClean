...
|   Either a patch file wouldn't say which patch it is, or it wouldn't say which programs it's for, or Windows wouldn't say in full which programs have that patch. |   要么某个补丁文件没有说明它是哪个补丁，要么没有说明它适用于哪些程序，要么 Windows 没有完整说明哪些程序装有该补丁。 |
