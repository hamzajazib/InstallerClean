...
|   Either a patch file wouldn't say which patch it is, or it wouldn't say which programs it's for, or Windows wouldn't say in full which programs have that patch. |   Ya bir yama dosyası hangi yama olduğunu söylemedi ya da hangi programlar için olduğunu söylemedi ya da Windows o yamanın hangi programlarda bulunduğunu eksiksiz söylemedi. |
